...
#if LV_FONT_MONTSERRAT_LATINO_12
LV_FONT_DECLARE(montserrat_latino_12)
#endif

#if LV_FONT_MONTSERRAT_LATINO_14
LV_FONT_DECLARE(montserrat_latino_14)
#endif

#if LV_FONT_MONTSERRAT_LATINO_16
LV_FONT_DECLARE(montserrat_latino_16)
#endif

#if LV_FONT_MONTSERRAT_LATINO_20
LV_FONT_DECLARE(montserrat_latino_20)
#endif

#if LV_FONT_MONTSERRAT_LATINO_26
LV_FONT_DECLARE(montserrat_latino_26)
#endif
